...
/**
 * Agent负责链接Distribute，MBeanServer,MBean
...
// 调用MBean的方法，然后生产我们的资源的一个对象。
        ...
        ObjectName helloName = new ObjectName(domainName+":name=HelloWorld");//为MBean（下面的new Hello()）创建ObjectName实例

        Hello hello = new Hello();
        mbs.registerMBean(hello,helloName);// 将new Hello()这个对象注册到MBeanServer上去
        startAdapter(mbs, domainName);
        
        hello.printHello("testFirst");

    }

    private static void startAdapter(MBeanServer mbs, String domainName)
